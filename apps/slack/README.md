# Nora Fleet Slack Bot Setup Guide

This guide will walk you through setting up the Nora Fleet Slack bot from scratch.

## Prerequisites

- Python 3.10 or higher
- A Slack workspace where you have admin permissions
- Nora Fleet server running locally
- `slack_bolt>=1.27.0`
...
4. Enter:
   - **App Name**: `Nora Fleet Bot` (or your preferred name)
...
- **Short Description**: `List all available Nora Fleet networks`
- Click **"Save"**

### Command 2: `/nora_fleet_help`
- **Command**: `/nora_fleet_help`
...
# Nora Fleet server port
NORA_SERVER_HTTP_PORT=8080 (or any port you want)
```

**Replace the tokens with the ones you copied earlier.**

## Step 10: Start the Nora Fleet Server

Make sure your Nora Fleet server is running on the port specified in `.env`:
...
### Connection errors
- Verify Nora Fleet server is running
- Check `NORA_SERVER_HTTP_PORT` matches your server
...
- `/nora_fleet_help` - Show usage instructions
...
| Get help | `/nora_fleet_help` | `/nora_fleet_help` |
