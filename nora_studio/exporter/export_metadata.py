...
from nora_studio.utils.hocon_text import HoconText
...
class ExportMetadataStamper:
    ...
    def build(self) -> Dict[str, str]:
        ...
        return {
            ...
            "export_nora_studio_version": studio_version(),
        }
