...
from nora_studio.coded_tools.global_only_resolver import GlobalOnlyResolver
from nora_studio.coded_tools.utils.pdf_utils import PdfUtils
...
class WebFetch(CodedTool):
    ...
    async def _fetch_pdf(self, url: str, session: ClientSession) -> str:
        ...
        This method is temporary: once nora-fleet supports multimodal input, the PDF
