...
class ProcessLogBridge(ProcessLoggerInterface):
    ...
    # ---------- special NoraFleet block ----------
    def _rebuild_norafleet_request_reporting(self, text_block: str) -> Optional[Dict[str, Any]]:
        """
        Detect and rebuild NoraFleet request-reporting blocks.
    ...
    def _emit_collected(self, state: Dict[str, Any], block: str) -> None:
        ...
        Decision logic:
            ...
            - If it matches NoraFleet request-reporting -> rebuild + emit.
        ...
        rebuilt = self._rebuild_norafleet_request_reporting(block)
