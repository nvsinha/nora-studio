...
class PhoenixPlugin(BasePlugin):
    """Plugin for Phoenix/OpenTelemetry observability in Nora Studio."""
    ...
    def get_default_config() -> dict:
        ...
        return {
            ...
            "otel_service_name": os.getenv("OTEL_SERVICE_NAME", "nora-fleet-demos"),
    ...
    def _configure_tracer_provider(self) -> None:
        ...
        service_name = os.getenv("OTEL_SERVICE_NAME", "nora-fleet-demos")
    ...
    def set_environment_variables(self) -> None:
        ...
        os.environ["OTEL_SERVICE_NAME"] = self.config.get("otel_service_name", "nora-fleet-demos")
