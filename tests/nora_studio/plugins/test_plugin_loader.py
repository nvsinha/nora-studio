...
plugins = [
    {
        class = "nora_studio.interfaces.base_plugin.BasePlugin"
        enabled = true
    }
]
"""
...
plugins = [
    {
        class = nora_studio.interfaces.plugins.NonexistentClass
        enabled = true
    }
]
"""
...
class TestResolvePluginsFile:
    ...
    def test_falls_back_to_bundled(self, tmp_path: Path) -> None:
        ...
        assert result.endswith(os.path.join("nora_studio", "templates", "plugins.hocon"))
