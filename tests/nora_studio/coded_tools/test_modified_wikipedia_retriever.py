...
from nora_studio.coded_tools.modified_wikipedia_retriever import WIKIPEDIA_MAX_QUERY_LENGTH
from nora_studio.coded_tools.modified_wikipedia_retriever import ModifiedWikipediaRetriever

MODULE = "nora_studio.coded_tools.modified_wikipedia_retriever"
