...
from nora_studio.coded_tools.jira_toolkit import JiraAPIWrapper
from nora_studio.coded_tools.jira_toolkit import JiraToolkit
...
def test_token_only_authentication_is_shared_by_jira_and_confluence(monkeypatch):
    ...
    with (
        patch("nora_studio.coded_tools.jira_toolkit.JIRA_TYPE", jira_type),
        patch("nora_studio.coded_tools.jira_toolkit.CONFLUENCE_TYPE", confluence_type),
    ):
        JiraAPIWrapper()
