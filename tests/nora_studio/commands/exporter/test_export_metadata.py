...
from nora_studio.exporter.agent_network_exporter import AgentNetworkExporter
from nora_studio.exporter.export_metadata import ExportMetadataStamper

_EXPORT_KEYS = {"export_user", "export_time", "export_nora_studio_version"}
...
class TestBuildExportMetadata:
    ...
    def test_version_is_non_empty(self) -> None:
        """export_nora_studio_version carries the bare studio version string."""
...
class TestStamp:
    ...
    def test_injects_explanatory_comment_above_keys(self) -> None:
        ...
        assert "# nora export metadata" in stamped
        comment_at = stamped.index("# nora export metadata")
    ...
    def test_restamping_updates_in_place_without_duplicating(self) -> None:
        ...
        assert twice.count("# nora export metadata") == 1
...
def built_version(built: dict) -> str:
    ...
    return built["export_nora_studio_version"]
