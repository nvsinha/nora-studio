...
from nora_fleet.internals.validation.network.structure_network_validator import StructureNetworkValidator
from nora_fleet.internals.validation.network.toolbox_network_validator import ToolboxNetworkValidator
...
class AgentNetworkStructureValidationMiddleware(AgentNetworkValidationMiddleware):
    ...
    async def validate(self, network_def: dict[str, Any]) -> list[str]:
        ...
        # client supplied auth headers for via sly_data (nora_flow injects one
