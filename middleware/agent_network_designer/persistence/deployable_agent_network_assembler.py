...
from nora_fleet.internals.graph.filters.dictionary_common_defs_config_filter import DictionaryCommonDefsConfigFilter
...
class DeployableAgentNetworkAssembler(AgentNetworkAssembler):
    ...
    def filter_agent(
        ...
        We need to use the CommonDefs filters from nora_fleet in order to insert the common AAOSA
        ...
        """
        # Create a network spec so the ConfigFilters from nora_fleet can work on it
