...
class AgentNetworkAssembler:
    ...
    def build_mcp_sly_data_schema(
        ...
        supply outside the chat stream. In particular, nora_flow reads
        ...
        (nora_flow injects one per connected server). Servers configured in
        ...
        declared URL is also in `required`, so clients like nora_flow gate
        ...
        # with nora-fleet's own network validators.
