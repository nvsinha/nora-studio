...
class NoraFlowSelenium(CodedTool):
    """
    CodedTool implementation which opens nora_flow in Chrome, enters text input,
    ...
    def invoke(self, args: Dict[str, Any], sly_data: Dict[str, Any]) -> str:
        ...
        :param args: An argument dictionary whose keys are the parameters
            ...
            The argument dictionary expects the following keys:
                ...
                "url": URL of nora_flow to run the network
        ...
        return connect_run_agent_nora_flow(
...
def connect_run_agent_nora_flow(
    url: str,
    agent_name: str,
    query: str,
    ...
    Opens the specified URL of nora_flow client, selects an agent by name from the sidebar, sends a query message,
