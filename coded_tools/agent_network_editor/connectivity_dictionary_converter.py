...
# Reaching into nora_fleet internals because we expect to know the gory details here because
...
class ConnectivityDictionaryConverter(DictionaryConverter):
    ...
    def _load_shared_toolbox_factory() -> ContextTypeToolboxFactory:
        ...
        half-initialized factory, and — because nora-fleet 0.6.83's
    ...
    # ships inside the nora-fleet package and the optional override comes from
