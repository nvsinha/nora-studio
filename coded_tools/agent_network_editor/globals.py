...
also keeps this module (and test collection through it) free of nora-fleet
imports.
"""
...
class ProcessGlobals:  # pylint: disable=too-few-public-methods
    ...
    #    Holds:   a load()-ed nora-fleet ContextTypeToolboxFactory used to render
    ...
    def clear_all_for_testing():
        ...
        nora-fleet internals, and pytest collection stays light. A module absent
