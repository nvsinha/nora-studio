...
Complete integration module for ServiceNow AI agents with the Nora Fleet framework. This module enables discovery, interaction, and response retrieval from ServiceNow's Agentic AI platform.
...
# Optional: LLM Provider (for Nora Fleet orchestration)
...
- **Framework Integration**: Follows Nora Fleet `CodedTool` interface patterns
