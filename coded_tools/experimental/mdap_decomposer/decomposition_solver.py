...
from coded_tools.experimental.mdap_decomposer.nora_fleet_solver import NoraFleetSolver
...
class DecompositionSolver(BranchActivation, CodedTool):
    """
    A CodedTool implementation that uses the NoraFleetSolver to break down
