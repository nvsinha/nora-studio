...
A research report generation system using CrewAI agents integrated with the A2A (Agent-to-Agent) protocol. This project demonstrates how to connect agents from another framework with Nora Fleet using A2A protocal.
...
nora_flow is a developer-oriented web client. From the root of the repo, run the command:
