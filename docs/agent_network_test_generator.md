...
[data-driven test fixture HOCON files](https://github.com/nvsinha/nora-fleet/blob/main/docs/test_case_hocon_reference.md)
...
nora-fleet test case HOCON schema.
...
coded tool, which:
   ...
   - Prepends a reference comment linking to the
     [test case HOCON schema documentation](https://github.com/nvsinha/nora-fleet/blob/main/docs/test_case_hocon_reference.md).
...
Produces complete test fixture dictionaries conforming to the nora-fleet test case HOCON
