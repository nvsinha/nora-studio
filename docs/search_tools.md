# Nora Fleet Search Tools

Nora Fleet offers search capability via the following search engines:
...
langchain-anthropic package is already included with nora-studio.

_Example Usage in Nora Studio_:

- [anthropic\_web_search.hocon](../nora_studio/coded_tools/anthropic_web_search.py),
- available as a tool in [toolbox_info.hocon](../nora_studio/toolbox/toolbox_info.hocon)
...
_Example Usage in Nora Studio:_

- [brave\_search.hocon](../registries/tools/brave_search.hocon),
- [real\_estate.hocon](../registries/industry/real_estate.hocon),
- available as a tool in [toolbox\_info.hocon](../nora_studio/toolbox/toolbox_info.hocon)
...
langchain-openai package is already included with nora-studio.
...
You.com is a developer-focused search platform designed for AI agents and automation. It integrates with Nora Fleet
...
[mcp\_info.hocon](../nora_studio/mcp/mcp_info.hocon)
...
[mcp\_info.hocon](../nora_studio/mcp/mcp_info.hocon). Only `you-search` is available on this profile.

_Example Usage in Nora Studio:_

- [you\_search.hocon](../registries/tools/you_search.hocon),
- see also [MCP server configuration](../nora_studio/mcp/mcp_info.hocon)
