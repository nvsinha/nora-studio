...
that agents can use within the Nora Studio framework.
...
Provide current date and time for a specified timezone (default to UTC). This tool is in Nora Fleet's default toolbox.
...
Make HTTP requests to external APIs and web services. These tools are from Nora Fleet's default toolbox.
...
Refer to the detailed configuration instructions in the [Toolbox HOCON file](../nora_studio/toolbox/toolbox_info.hocon)
...
* **[Toolbox Configuration Reference](../nora_studio/toolbox/toolbox_info.hocon)** — Complete tool definitions and parameters
<!-- pyml disable-next-line line-length -->
* **[Default Toolbox](https://github.com/nvsinha/nora-fleet/blob/main/nora_fleet/internals/run_context/langchain/toolbox/toolbox_info.hocon)** — Nora Fleet's default toolbox
