...
A CodedTool implementation defined in [wikimedia_media_search.py](../../nora_studio/coded_tools/wikimedia_media_search.py) that searches Wikimedia Commons for media files.
