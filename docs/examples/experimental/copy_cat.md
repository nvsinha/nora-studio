...
using Nora Fleet's Reservations API.
...
network can create another agent network by use of the Nora Fleet Reservations API.
...
The idea is that if a generic client like nora_flow or MAUI can expect this particular key
...
- [Coded Tools Implementation Guide](https://github.com/nvsinha/nora-studio/blob/main/docs/user_guide.md#coded-tools)
  Learn how to implement and integrate custom coded tools in Nora Studio.

- [ReservationUtil helper class](https://github.com/nvsinha/nora-fleet/blob/main/nora_fleet/internals/reservations/reservation_util.py)
  Learn how to use the ReservationUtil helper class in Nora Fleet.  This is the simplest entrypoint into createing temporary networks and it is what the copyist tool uses.

- [Reservationist.py interface class](https://github.com/nvsinha/nora-fleet/blob/main/nora_fleet/interfaces/reservationist.py)
...
- [Reservation.py interface class](https://github.com/nvsinha/nora-fleet/blob/main/nora_fleet/interfaces/reservation.py)
