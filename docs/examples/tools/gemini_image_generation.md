...
This is already included via langchain-google-genai, which is included with nora-studio,
...
- [Agent HOCON Reference](https://github.com/nvsinha/nora-fleet/blob/main/docs/agent_hocon_reference.md)  
