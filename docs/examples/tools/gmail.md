...
Here are the package versions from the last successful test (nora-fleet==0.6.21):
...
- [Toolbox implemenation](https://github.com/nvsinha/nora-studio/blob/main/docs/user_guide.md#toolbox)
Learn how Nora Fleet integrates tools from langchain including setup, configuration, and tool extension.
