...
nora-studio check-config

# Validate a specific HOCON file
nora-studio check-config registries/music_nerd.hocon
nora-studio check-config path/to/llm_config.hocon
```
...
Both formats produced by `nora-studio` are accepted:
