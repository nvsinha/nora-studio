# Contributing to Nora Studio

Thank you for your interest in contributing to Nora Studio! This document provides guidelines and instructions for contributing to the project.
...
Please report any unacceptable behavior to ****.
...
2. Review the [User Guide](docs/user_guide.md) to understand how Nora Fleet works
3. Check out the [Tutorial](docs/tutorial.md) to get hands-on experience
4. Browse existing [Issues](https://github.com/nvsinha/nora-studio/issues) and [Pull Requests](https://github.com/nvsinha/nora-studio/pulls)
5. Browse existing [Discussions](https://github.com/nvsinha/nora-studio/discussions) to see if your topic has already been addressed
...
1. **Fork the repository**
   ...
   Visit [https://github.com/nvsinha/nora-studio](https://github.com/nvsinha/nora-studio) and click the "Fork" button.

2. **Clone your fork**

   ```bash
   git clone https://github.com/your-username/nora-studio.git
   cd nora-studio
   ```
...
6. **Add upstream remote**
   ...
   ```bash
   git remote add upstream https://github.com/nvsinha/nora-studio.git
   ```
...
- Check the [Issues](https://github.com/nvsinha/nora-studio/issues) page for open issues
- Look for issues labeled `good first issue` or `help wanted`
- If you have a new idea, open a new [discussion](https://github.com/nvsinha/nora-studio/discussions) first to discuss it with maintainers
...
2. **Create a Pull Request**
   - Go to the [repository](https://github.com/nvsinha/nora-studio)
...
- **Issues**: Search existing [issues](https://github.com/nvsinha/nora-studio/issues) or create a new one
- **Discussions**: Use [GitHub Discussions](https://github.com/nvsinha/nora-studio/discussions) for questions and ideas
...
- **Main Library**: [nora-fleet](https://github.com/nvsinha/nora-fleet)
- **Developer UI**: [nora-flow](https://github.com/nvsinha/nora-flow)
- **Shared Utilities**: [nora-common](https://github.com/nvsinha/nora-common)
...
2. Search [GitHub Discussions](https://github.com/nvsinha/nora-studio/discussions) for similar questions
3. Ask in [GitHub Discussions](https://github.com/nvsinha/nora-studio/discussions) - this is the best place for questions!
4. Search existing issues (for bug reports only)

For general support, see [SUPPORT.md](SUPPORT.md).

Thank you for contributing to Nora Studio!
